/* Conroy's Training App - core part A 4.0.1 */
// ========== AUTH / USERS ==========
    const DEFAULT_USERS = [
    ...
    function showWelcomeInDock() {
      ...
      if (!alreadyGreeted) {
        ...
        // Always address by name on return visits too
        const help = ({
          ko: name + '님, 무엇을 도와드릴까요?',
          en: name + ', how can I help?',
          ja: name + 'さん、何かお手伝いしましょうか？',
          es: name + ', ¿en qué puedo ayudar?'
        })[L];
        msg = help + '\n' + nextLine;
      }
